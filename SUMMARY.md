...
* [Exercise 4: Publish application to Azure](exercise-4.md)
* [Exercise 5: Test HueBot Using Microsoft Teams](exercise-5-test-huebot-using-microsoft-teams.md)
* [Exercise 6: Modify Speech Recognition and Publish in Debug mode.](exercise-6-modify-speech-recognition-and-publish-in-debug-mode..md)
* [Exercise 7: Test new HubBot changes with Remote Debugging.](exercise-7-test-new-hubbot-changes-with-remote-debugging..md)
